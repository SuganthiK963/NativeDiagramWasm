#pragma checksum "D:\Diagram Blazor\GitHub\NativeDiagramWasm\Pages\MultiConOrthSeg-NodeToNode.razor" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "ead314ecf849c886b3a3485b060e6a020c62ea55"
// <auto-generated/>
...
#nullable disable
#nullable restore
#line 3 "D:\Diagram Blazor\GitHub\NativeDiagramWasm\Pages\MultiConOrthSeg-NodeToNode.razor"
...
#nullable disable
#nullable restore
#line 4 "D:\Diagram Blazor\GitHub\NativeDiagramWasm\Pages\MultiConOrthSeg-NodeToNode.razor"
using System.Collections.ObjectModel;

#line default
#line hidden
#nullable disable
    [Microsoft.AspNetCore.Components.RouteAttribute("/MultipleConnectorOrthoSegment/NodeToNode")]
    public partial class MultiConOrthSeg_NodeToNode : Microsoft.AspNetCore.Components.ComponentBase
    {
...
#nullable restore
#line 6 "D:\Diagram Blazor\GitHub\NativeDiagramWasm\Pages\MultiConOrthSeg-NodeToNode.razor"
                                                                   nodes
...
#nullable restore
#line 8 "D:\Diagram Blazor\GitHub\NativeDiagramWasm\Pages\MultiConOrthSeg-NodeToNode.razor"
    ...
    protected override void OnInitialized()
    {
        ...
        for (var i = 0; i < 9; i++)
        {
            Node node = new Node {
                ...
                Ports=new DiagramObjectCollection<PointPort>()
                        {
                            new PointPort(){ID="Port1", Offset=new Point{X=0, Y=0.5}},
                            new PointPort(){ID="Port2", Offset=new Point{X=0.5, Y=0}},
                            new PointPort(){ID="Port3", Offset=new Point{X=1, Y=0.5}},
                            new PointPort(){ID="Port4", Offset=new Point{X=0.5, Y=1}},
                        }
            };
            if (node.ID == "node1")
            {
        ...
        nodes.Add(new Node{ ID= "node13", OffsetX= 300, OffsetY= 700, Width= 50, Height= 50 });
        nodes.Add(new Node{ ID= "node14", OffsetX= 450, OffsetY= 700, Width= 50, Height= 50 });
        nodes.Add(new Node{ ID= "node15", OffsetX= 100, OffsetY= 850, Width= 50, Height= 50 });
        nodes.Add(new Node{ ID= "node16", OffsetX= 700, OffsetY= 1150, Width= 50, Height= 50 });
        ...
        string[] targetNodes = new string[] {"node3", "node1", "node7", "node5",
        "node13", "node14", "node15", "node16" };
        string[] sourceNodes = new string[] {"node0", "node2", "node6", "node8",
